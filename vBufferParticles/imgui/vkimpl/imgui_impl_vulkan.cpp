...
bool ImGui_ImplVulkan_CreateDeviceObjects(unsigned int subpassId);// HAZE_FIX added arg subpassId
...
bool ImGui_ImplVulkan_CreateDeviceObjects(unsigned int subpassId)// HAZE_FIX added arg subpassId
{
	...
	info.subpass = subpassId;// HAZE_FIX added this line to allow ImGui to be used in subpass 1 instead of 0 here
...
bool    ImGui_ImplVulkan_Init(ImGui_ImplVulkan_InitInfo* info, VkRenderPass render_pass, unsigned int subpassId)// HAZE_FIX added arg subpassId
{
    ...
    ImGui_ImplVulkan_CreateDeviceObjects(subpassId);
